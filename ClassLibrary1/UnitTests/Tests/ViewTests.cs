...
namespace UnitTests.Tests
{
    ...
    public class ViewTests
    {
        ...
        public void Initialize()
        {
            ...
            ListViews = new List<ViewForTable> { previewAllView, defaultView };
        ...
        public void CanGeViewsForUser()
        {
            profileRepository.Setup(c => c.Get(It.IsAny<string>()))
                .Returns(new Entity.Profile { Customer = new Customer { Views = new List<ViewForTable> { new ViewForTable { Id = 99, Name = "UserView" } } } });
        ...
        {
            viewRepository.Setup(m => m.Create(It.IsAny<ViewForTable>()))
                .Callback<ViewForTable>(ListViews.Add);
        ...
        public void CanUpdateViewInCreateOrUpdate()
        {
            viewRepository.Setup(c => c.IsExist(It.IsAny<int>()))
                .Returns((int i) => ListViews.Any(c => c.Id == i));
            viewRepository.Setup(m => m.Update(It.IsAny<ViewForTable>())).Callback<ViewForTable>(p =>
            {
        ...
        public void CanAddViewTemplateToView()
        {
            ...
            viewService.AddViewTemplateToView(new ViewForTable { ViewTemplateId = 1 }, 1);
        ...
        public void CanNotAddViewWithNotSetIdOfViewTemplate()
        {
            ...
            viewService.AddViewTemplateToView(new ViewForTable(), null);
        }
        ...
        public void CanNotAddPositionInNonexistentPortfolio()
        {
            ...
            viewService.AddViewTemplateToView(new ViewForTable(), 11);
        }
        ...
        //    viewService.AddPortfolioToView(new ViewForTable { ViewTemplateId = 1 }, 1);
